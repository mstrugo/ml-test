...
<body>
	...
	<section id="contenedor">
		...
		<article>
			...
			<section class="right">
				<header><h2>$4799<sup>99</sup></h2></header>
				<article>
			...
			<section class="bottom">
				<div class="tab tab0" tabindex="0">
					<header><h2>Product description</h2></header>
				...
				<div class="tab tab0" tabindex="0">
					...
					<dl>
						<dt>Buyer</dt>
						<dd>Do you have this one in white?</dd>
						<dt>Seller</dt>
						<dd>No I don't, I only have black</dd>
					</dl>
